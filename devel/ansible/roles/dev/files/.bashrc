...
export FLASK_APP=/vagrant/noggin/app.py
export NOGGIN_CONFIG_PATH=/home/vagrant/noggin.cfg
export PATH=$PATH:/home/vagrant/.local/bin

alias noggin-start="sudo systemctl start noggin.service && echo 'Noggin is running on http://0.0.0.0:5000'"
alias noggin-unit-tests="NOGGIN_CONFIG_PATH=/vagrant/noggin/tests/unit/noggin.cfg poetry run pytest -vv --cov noggin/ --cov-report term-missing noggin/tests/unit"
